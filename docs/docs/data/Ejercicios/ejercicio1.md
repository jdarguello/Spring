...
Construye un microservicio para el manejo de __inversiones virtuales__ del BancoC. El microservicio debe ser capaz de aprobar o rechazar solicitudes de inversión (dependiendo del saldo de los clientes), debe ser capaz de realizar el retiro de dinero en la cuenta de origen para abrir la inversión y especificar hacia qué cuenta retornar el dinero. En las Figuras 1 y 2, se observan los modelos y tablas SQL recomendadas para resolver el ejercicio.
